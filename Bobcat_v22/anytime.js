    ...
    AnyTime.picker = function( id, options )
    {
        ...
        __pickers[id] =
        {
            ...
            initialize: function( id )
            {
                ...
                /** VMIPSL **/
                if( options.methodToCall )
                    this.methodToCall = options.methodToCall;

                /** VMIPSL **/
                if( options.idToUpdateEarliest )
                    this.idToUpdateEarliest = options.idToUpdateEarliest;
            ...
            /** VMIPSL **/
            updateEarliest: function()
            {
                if( !this.idToUpdateEarliest || !$( document.getElementById( this.idToUpdateEarliest ) )[0] || !$( document.getElementById( this.idToUpdateEarliest ) )[0].value )
                    return;

                this.earliest = this.conv.parse( $( document.getElementById( this.idToUpdateEarliest ) )[0].value ).getTime();
            },
