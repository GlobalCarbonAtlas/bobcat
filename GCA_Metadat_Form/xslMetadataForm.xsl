...
<head>
    <meta charset="utf-8"/>
    <title>xsl Metadata GCA</title>
    <link rel="stylesheet" href="css/xslMetadataForm.css" media="screen"/>
...
<div id= "containerBasicInfo" class= "containerInfoClass">
 <div id= "basicInfoTitle" class= "title1">Basic Information:</div>
  <div id= "aboutDataTitle" class= "title2">About data:</div>
   <div id= "creationDateTitle" class= "title3">Creation date:</div>
    <div id= "creationDate" class= "respFromXml">date truc</div>
   <div id= "productNameTitle" class= "title3">Product name (type-category-title-version):</div>
