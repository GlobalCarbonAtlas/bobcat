            ...
            <div class="form-group">
                ...
                <div class="row col-md-24 col-sm-24">
                    ...
                    <div id="containerMapInfoSpatCov" class="col-md-24 col-sm-24">
                        <div id='map_element'>
                            <div id="mapPanel" class="cursorPointer" title="Click to turn to initial view (entire world)"></div>
                        </div>
                    </div>
                </div>
...
<div id="showResultButton" class="cursorPointer"
     title="Visualise the result of the metadata file. You can change your answers if you are not satisfied (You have to turn to submit the form before!)" style="display:none">Show
    the result
</div>
</div>
