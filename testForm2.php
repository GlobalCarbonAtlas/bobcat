...
http://www.uncertml.org/2.0 http://www.uncertml.org/uncertml.xsd" id="dataset_MD">
	...
	<gmd:identificationInfo>
		<gvq:GVQ_DataIdentification>
			...
			<gmd:abstract>
				<gco:CharacterString>Annual climatic digital maps, of mean temperature. Maps have been generated by means of statistical techniques, Geographic Information Systems and spatial interpolation.</gco:CharacterString>
			</gmd:abstract>';
$xmlStringPart3= '<gmd:descriptiveKeywords>
			...
			<gmd:extent>
                <gmd:EX_Extent>
                    <gmd:description>
                        <gco:CharacterString>Temporal resolution: '.$_POST["temporalResolutionSelectPost"].$_POST["temporalResolutionInputPost"].'</gco:CharacterString>
                    </gmd:description>
                </gmd:EX_Extent>
            </gmd:extent>
            <gmd:extent>
            ...
            <gmd:extent>
                <gmd:EX_Extent>
                    <gmd:description>
                        <gco:CharacterString>Vertical level: '.$_POST["verticalLevelPost"].'</gco:CharacterString>
                    </gmd:description>
                </gmd:EX_Extent>
            </gmd:extent>
		</gvq:GVQ_DataIdentification>
    ...
    <gvq:GVQ_DataQuality>
                ...
                <gmd19157:DQ_StandaloneReportInformation>
                    <gmd19157:reportReference>
                        <gmd19157:DQM_SourceReference>
                            <gmd19157:citation>
                                <gco:CharacterString>url du doc</gco:CharacterString>
                            </gmd19157:citation>
                        </gmd19157:DQM_SourceReference>
                    </gmd19157:reportReference>
                    <gmd19157:abstract>
                        <gco:CharacterString>Description du doc en question</gco:CharacterString>
                    </gmd19157:abstract>
                </gmd19157:DQ_StandaloneReportInformation>
            </gmd19157:standAloneReport>
            ...
            <gvq:discoveredIssue>
                <gvq:GVQ_DiscoveredIssue>
                    ...
                    <gvq:knownProblem>
                        <gco:CharacterString>'.$_POST["discoveredIssueQualityDataPost"].'</gco:CharacterString>
                    </gvq:knownProblem>
                </gvq:GVQ_DiscoveredIssue>
            </gvq:discoveredIssue>
	...
	// On a besoin d'y avoir acces depuis exterieur boucle :
	//echo $xmlStringPart2DataContributor;//OK

	//  2) $xmlStringPart3AuthorsInfo:
	//$nAuthorsInfos= $_POST["nAuthorsInfosPost"];// A construire.
	$xmlStringPart3AuthorsInfoS=
		'<gvq:referenceDoc>
				<gvq:GVQ_Publication id="idCitation">
					<gmd:title>
						<gco:CharacterString>".$_POST["citationTitle1Post"]."</gco:CharacterString>
					</gmd:title>
					<gmd:date>
						<gmd:CI_Date>
							<gmd:date>
								<gco:Date>".$_POST["citationBookDate1Post"]."</gco:Date>
							</gmd:date>
							<gmd:dateType>
					...
					<gmd:role>
						<gmd:CI_RoleCode codeList="http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#CI_RoleCode" codeListValue="author">Role: </gmd:CI_RoleCode>
					</gmd:role>
					</gmd:CI_ResponsibleParty>
					<gmd:citedResponsibleParty>
					<gmd:series>
						<gmd:CI_Series>
							<gmd:name>
								<gco:CharacterString>Theoretical and Applied Climatology</gco:CharacterString>
							</gmd:name>
						</gmd:CI_Series>
					</gmd:series>
			*/		<gvq:target xlink:href="linkToPubli"/>
					<gvq:doi>
						<gco:CharacterString>10.1007/s00704-006-0264-2</gco:CharacterString>
					</gvq:doi>
					<gvq:scope xlink:href="#datasetScope"/>
					<gvq:category>
						<gvq:GVQ_PublicationCategoryCode codeList="http://schemas.geoviqua.org/GVQ/4.0/resources/Codelist/gvqCodelists.xml#GVQ_PublicationCategoryCode" codeListValue="journalArticle">journalArticle</gvq:GVQ_PublicationCategoryCode>
					</gvq:category>
					<gvq:onlineResource>
						<gmd:CI_OnlineResource>
							<gmd:linkage>
								<gmd:URL>http://www.springerlink.com/content/06463p2677318556/</gmd:URL>
							</gmd:linkage>
						</gmd:CI_OnlineResource>
					</gvq:onlineResource>
				</gvq:GVQ_Publication>
	...
	// On Regroupe les differentes parties du xml pour creer le xml entier :
		$xmlString= $xmlStringPart1.$xmlStringPart2DataContributor.$xmlStringPart3;
