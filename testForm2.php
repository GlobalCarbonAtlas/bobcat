...
//$docDom->save("xmlDoneByForm/".$_POST["dataProductTypeSelectPost"].$_POST["dataProductTypeInputPost"].'_'.$_POST["dataProductCategorySelectPost"].$_POST["dataProductCategoryInputPost"].'_'.$_POST["prodNameTitlePost"].'_'.$_POST["prodNameVersionPost"].".xml");
